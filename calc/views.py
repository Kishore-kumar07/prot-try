...
def store_results_in_database(rawdata, result, normal_table_name, encrypted_input, encrypted_result, encrypted_table_name):
    try:
        ...
        con = mysql.connector.connect(host='localhost', user='root', password='dhanush@123', database='your_database_name')  # Replace 'your_password' and 'your_database_name' with your MySQL password and database name
...
def checkSpam(request):
    if request.method == "POST":
        ...
        if algo == "RANDOM CLASSIFIER":
            ...
            return render(request, 'output.html', {"answer": res})
